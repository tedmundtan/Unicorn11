...
@WebServlet(name = "projections", urlPatterns = {"/json/wishlist"})
public class ProjectionsJSON extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, String> overview = getWishListItem(input);
